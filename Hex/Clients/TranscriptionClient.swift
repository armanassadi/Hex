...
actor TranscriptionClientLive {
  ...
  private lazy var modelsBaseFolder: URL = {
    do {
      ...
      // Typically: .../Application Support/<bundleIdentifier>
      let ourAppFolder = appSupportURL.appendingPathComponent(HexCoreConstants.bundleIdentifier, isDirectory: true)
